...
def _check_project_python(project_python: str) -> None:
    """Check if the PROJECT_PYTHON executable exists."""
...
def _test_module_import() -> None:
    """Test importing the project module."""
    src_path = Path("src")
...
def main() -> NoReturn:
    ...
    _check_project_python(project_python)
