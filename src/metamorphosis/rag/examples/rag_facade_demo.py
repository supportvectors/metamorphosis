...
#
#  Short Description: Demo of the new rag() facade method in ProjectsRag class.
#
...
"""
Demo of the new rag() facade method in the ProjectsRag class.
...
def main():
    ...
    try:
        ...
        print("🤖 LLM RESPONSE")
        print("🤖"*20)
        projects.display_llm_response(result['llm_response'], query)
